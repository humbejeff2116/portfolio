...
export default function About() {
    ...
    return (
        ...
        <motion.div
            ...
            className="bg-gradient-to-b from-gray-950 to-black md:bg-white/0.5 backdrop-blur-lg md:backdrop-blur-sm z-20 max-w-3xl px-5 py-10 rounded-2xl shadow-sm shadow-indigo-500"
        >
            <motion.h2
