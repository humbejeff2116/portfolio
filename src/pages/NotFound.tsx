...
export default function NotFound() {
    return (
        ...
        <section id="projects" className="flex flex-col items-center justify-center min-h-screen px-6 text-center relative py-32 px-8 bg-gradient-to-b from-gray-950 to-black text-gray-400">
